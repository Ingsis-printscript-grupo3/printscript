    ...
    fun `ejemplo 1 de la consigna`() {
        ...
        assertEquals(
            listOf(
                ...
                TokenType.STRINGLITERAL, TokenType.PLUS, TokenType.IDENTIFIER, TokenType.RIGHTTPAREN,
    ...
    fun `ejemplo 2 de la consigna`() {
        ...
        assertEquals(
            listOf(
                ...
                TokenType.IDENTIFIER, TokenType.RIGHTTPAREN, TokenType.SEMICOLON, TokenType.EOF,
            ),
            types(source),
        )
    }
