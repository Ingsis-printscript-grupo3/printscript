...
class Interpreter(
    ...
    private fun execute(statement: Statement) {
        val plugin = statementInterpreters.firstOrNull { it.matches(statement) }
    ...
    override fun evaluate(expression: Expression): Value {
        val plugin = expressionEvaluators.firstOrNull { it.matches(expression) }
